...
## 远场条件（重要）
### 小天线
如果天线的尺寸远小于波长（$D \ll \lambda$），直接近似偶极子，远场条件： $$R_{ff} > \frac{\lambda}{2\pi}$$ （这里到底有没有等号呀）
...
## 天线增益
综合考虑方向性和天线的损耗后可以得到，单位是$dBi$：

$$G=10log_{10}\left(De_{loss}\right)$$ 

老师PPT上放的公式是孔径天线的，我觉得这里应该用普适的公式，所以删了。
### 无耗偶极子天线
...
$$G=10log_{10}\left(\frac{P@_{\theta=30\degree}}{P_{ave}}\right)=10log_{10}\left(\frac{P_{max}}{P_{ave}}\times\frac{P@_{\theta=30\degree}}{P_{max}}\right)=10log_{10}\left(D\times P_n@_{\theta=30\degree}\right)=-4.25dBi$$
