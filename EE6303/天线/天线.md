...
$$G=10log_{10}\left(\frac{P_{\theta=30\degree}}{P_{ave}}\right)=10log_{10}\left(\frac{P_{max}}{P_{ave}}\times\frac{P_{\theta=30\degree}}{P_{max}}\right)=10log_{10}\left(D\times P_{n_{{\theta=30\degree}}}\right)=-4.25dBi$$
