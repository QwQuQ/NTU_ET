...
$$G=10log_{10}\left(\frac{P_{\text{max}}}{\frac{1}{4\pi}P_{in}}\right)=10log_{10}\left(\frac{P_{\text{max}}}{P_{\text{ave}}}\frac{P_{\text{ave}}}{\frac{1}{4\pi}P_{\text{in}}}\right)=10log_{10}\left(\frac{P_{\text{max}}}{P_{\text{ave}}}\frac{P_t}{P_{\text{in}}}\right)=10log_{10}\left(De\right)$$

如果 $e=1$ 有 $\frac{P_{\text{in}}}{4\pi}=\frac{P_{t}}{4\pi}=P_{\text{ave}}$：

$$G=10log_{10}\left(\frac{P_\theta}{P_{\text{ave}}}\right)$$
